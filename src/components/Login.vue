                        ...
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="sorybana92@gmail.com"
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="/forgot-password" class="small text-right">Recover my password</a></div>
                                </div>
                            </div>
                            <div class="d-grid">
                                <button type="button" class="btn btn-gray-800" v-on:click="login">Enter</button>
                            </div>
                        </div>
                    </div>
                </div>
